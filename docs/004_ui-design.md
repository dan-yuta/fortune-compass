...
- 19の占術カード（カテゴリごとにセクション分け、各カテゴリ内は2列グリッド）
  - 定番占い（4種）: 星座、数秘術、血液型、タロット
  - 誕生日占い（8種）: 干支、九星気学、動物占い、誕生花、誕生石、四柱推命、曜日占い、風水
  - 伝統占い（2種）: おみくじ、ルーン
  - 特殊占い（5種）: 夢占い、手相、相性占い、運勢トレンド、AI総合鑑定
- 各カード: アイコン + 占術名
- カードタップ → 対応する占い結果ページへ
...
**ヒーロー:** 動物キャラクターアイコン + カラーの動物名「キャラ名」（例: 「シルバーのこじか『華やかなこじか』」）
**結果カード:**
1. グループ（太陽 / 地球 / 月）+ グループ説明
2. 今日の運勢スコア
3. 性格・行動パターン
4. 相性の良い動物キャラ
5. アドバイス
