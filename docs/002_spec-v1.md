...
**判定ロジック:** 生年月日から60パターンの動物キャラクターを判定
- 生年月日をもとに換算テーブルを使用して60分類のキャラクターを決定
- 12種の動物（狼、こじか、猿、チーター、黒ひょう、ライオン、虎、たぬき、コアラ、ゾウ、ひつじ、ペガサス）× 5色の組み合わせ

**出力項目:** 動物名、カラー、キャラクター名、性格特徴、スコア(1-5)、相性の良い動物、アドバイス
...
**判定ロジック:** 天干地支 + ユリウス日から年柱・月柱・日柱を算出
1. ユリウス日数を算出して日柱の天干地支を求める
2. 年柱: `(生年 - 4) % 60` で六十干支のインデックスを決定
3. 月柱: 年干と月から月柱を算出
4. 日柱: ユリウス日数から日干支を決定
5. 十天干（甲乙丙丁戊己庚辛壬癸）と十二地支の組み合わせ

**出力項目:** 年柱、月柱、日柱、天干、地支、五行バランス、性格特徴、運勢傾向、アドバイス
