...
export const overallMessages = [
  '過去の冒険心が今の試練を経て、未来に希望の光をもたらすでしょう。',
  'これまでの経験が糧となり、新しいステージへと導かれています。',
  '内なる声に耳を傾けることで、真の道が見えてくるでしょう。',
  '変化の波が訪れています。恐れずに新しい流れに身を委ねましょう。',
  '過去からの学びが、今日の選択を正しい方向へ導いています。',
  '試練は成長の種です。乗り越えた先に大きな喜びが待っています。',
  '直感を信じて行動する時です。宇宙があなたを後押ししています。',
  '調和とバランスを大切にすることで、全てがうまく回り始めます。',
  '古いものを手放すことで、新しい可能性が開かれるでしょう。',
  '心の奥底にある情熱が、あなたを素晴らしい未来へ導きます。',
  '今こそ自分自身と向き合う時です。内省が大きな転機をもたらします。',
  '人との繋がりが幸運の鍵です。感謝の気持ちを忘れずに。',
];
