...
import { EtoResult } from "@/lib/types";
import { fetchEtoFortune } from "@/lib/api-client";
...
export default function EtoPage() {
  const { result, loading, error, retry } = useFortune<EtoResult>({
    fetcher: fetchEtoFortune,
  });
